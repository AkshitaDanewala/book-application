...
const countryNames = Country.getNames()
const languageNames = [
...
function writeBooks(b){
fs.writeFileSync("public/book.json", JSON.stringify(b))
}
...
router.get('/register', function(req, res, next) {
  ...
  res.render('register', {countryNames, languageNames });
});
...
router.post('/submit', function(req, res, next) {
 ...
 router.get('/show', function(req, res, next) {
  res.render('show', { readfiles: readfile()});
});
 ...
 router.get('/delete/:index', function(req, res, next) {
  ...
  router.get('/update/:index', function(req, res, next) {
    const x = readfile()
    const book = x[req.params.index]
    res.render("update", {countryNames,languageNames, index: req.params.index, book})
  });
